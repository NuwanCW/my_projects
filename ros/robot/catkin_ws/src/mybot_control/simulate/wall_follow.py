...
def clbk_laser(msg):
    ...
    regions_ = {
        ...
        'right': min(min(msg.ranges[45:135]), inf),
        'fright':  min(min(msg.ranges[135:170]), inf),
        'front':  min(min(msg.ranges[170:190]), inf),
        'fleft':   min(min(msg.ranges[190:225]), inf),
        'left':   min(min(msg.ranges[225:315]), inf),
